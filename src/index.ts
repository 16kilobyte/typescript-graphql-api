...
import { setupSentry, setupRedis, setupJwtAuth, permissions } from "./middlewares";
...
const startServer = async () => {
  ...
  while (retries) {
    ...
    if (isProduction) {
      ...
      Object.assign(connectionOptions, {
        ...
        subscribers: ["database/**/**/subscriber.js"],
  ...
  const server = new ApolloServer({
    ...
    context: ({ req, res }: Context) => ({ req, res, user: req.user }),
  });
